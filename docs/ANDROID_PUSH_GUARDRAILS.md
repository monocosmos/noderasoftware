...
- Global bildirim bile tek ortak kayit olarak tutulmaz; her alici icin ayri
  ...
  bazinda dogru kalir.
- Android tarafinda dort kanal vardir:
  ...
  `hotelops_shift_reminder` sesli kalici vardiya baslangic uyarisi.
- API varsayilan bildirimleri `hotelops_sound_transient` ile gonderir.
  ...
  `SHIFT_START_REMINDER` kanali ise `hotelops_shift_reminder` kanalina
  dusmeli ve ayni kullanici icin tek kalici bildirimi guncellemelidir.
