...
object HotelOpsPrefs {
    ...
    const val PUSH_REGISTER_LAST_ATTEMPT_AT = "push_register_last_attempt_at"
    const val PUSH_REGISTER_LAST_OK_AT = "push_register_last_ok_at"
    const val PUSH_REGISTER_LAST_STATUS = "push_register_last_status"
    const val PUSH_REGISTER_LAST_ERROR = "push_register_last_error"
